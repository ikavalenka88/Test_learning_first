...
public class MyFrame547 extends JFrame implements ItemListener {
    ...
    MyFrame547(){
        ...
        add(L);
        JLabel lbl = new JLabel("Please make a choose:");
